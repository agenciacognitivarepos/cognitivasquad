...
Squad responsável por criar conteúdo estratégico para o Instagram da Agência Cognitiva, contrastando notícias de IA com nossos produtos (Discovery, Readiness, Pilot, Ecosystem, Governance).
**Como Usar:**
/opensquad run instagram-squad

**Principais Agentes:**
1. Rita Referência (Pesquisadora) - Busca tendências e notícias reais.
2. Ítalo Instagram (Copywriter) - Cria ganchos de contraste e roteiros.
3. Vera Veredito (Revisora) - Garante autoridade e tom estratégico.
